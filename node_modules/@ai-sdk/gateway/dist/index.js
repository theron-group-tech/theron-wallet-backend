    ...
    try {
      const { value: responseBody } = await postJsonToApi({
        ...
        failedResponseHandler: createJsonErrorResponseHandler4({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage4(data)) != null ? _a13 : "unknown error";
          }
        }),
  ...
  async doGenerate(options) {
    ...
    try {
      const {
        ...
        body: args,
        successfulResponseHandler: createJsonResponseHandler5(z.any()),
      ...
      return {
        ...
        warnings: [...(_a12 = responseBody.warnings) != null ? _a12 : [], ...warnings]
      };
    } catch (error) {
      throw await asGatewayError(
        error,
